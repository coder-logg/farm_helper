...
var names = ['Петя', 'Абдуллах', 'Август', 'Моисей', 'Мордехай', 'Мстислав', 'Мурад',
    'Гизелла', 'Глафира', 'Альбина', 'Альвина', 'Ботогоз', 'Бояна', 'Бригитта']
...
for (i = 0; i < 15000; i++) {
    ...
    console.log("INSERT INTO _user (login, phone, mail, password) VALUES ('" + logins[i] + "'," + Mock.getMobile() + ",'" + Mock.getEmail() + "','" + pass_gen(10) + "');");
    console.log("INSERT INTO Review (id, sendler_login, message, rate) VALUES (" + i + ",'" + logins[i] + "','" + message_enum[rand1] + "'," + getRandomInt(10) + ");")
    console.log("INSERT INTO Review_List  (id, review_id,user_login) VALUES (" + i + "," + i + ",'" + logins[i] + "');")
};
for (i = 0; i < 7; i++) {
...
for (var i = 0; i < 10000; i++) {
    console.log("INSERT INTO Farm (id,location) VALUES (" + i + "," + getRandomInt(7) + ");")
    console.log("INSERT INTO Farmer (id,farmer_inf_login,balance,farm_id) VALUES (" + i + ",'" + logins[i] + "'," + getRandomInt(100) + "," + i + ");");
}
for (var i = 0; i < 5000; i++) {
    console.log("INSERT INTO Order_for_drive (id,driver_id,farmer_id,cost) VALUES (" + i + ",'" + logins[i + 10000] + "','" + logins[i] + "'," + getRandomInt(100) + ");");
    console.log("INSERT INTO Arbitration (id,order_id,driver_id,fermer_id) VALUES (" + i + "," + i + ",'" + logins[i + 10000] + "','" + logins[i] + "');");
}

for (i = 0; i < 10000; i++) {
    var number = getRandomInt(7);
    console.log("INSERT INTO Customer (id, name, phone, mail) VALUES (" + i + ",'" + names[number] + "'," + Mock.getMobile() + ",'" + Mock.getEmail() + "');")
}
